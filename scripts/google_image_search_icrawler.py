...
def build_google_candidates(query: str, max_num: int, session: Session) -> list[dict[str, str | None]]:
  signal = Signal()
...
def build_bing_candidates(query: str, max_num: int, session: Session) -> list[dict[str, str | None]]:
