...
1. **Identify the topic** from the user's request:
   - Getting started → `examples/getting-started/installation.md` or `examples/getting-started/quick-start.md`
   ...
   - BrowserWindow → `examples/api/browser-window.md`
...
Electron, desktop app, main process, renderer process, preload, IPC, BrowserWindow, Menu, Tray, Dialog, packaging, electron-builder, electron-forge, electron-fiddle, cross-platform, security, auto-updater, native modules, Electron API, Electron examples
